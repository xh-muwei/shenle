...
public class Send163MailUtil {
	 static String HOST = "smtp.163.com"; // smtp服务器
	    static String FROM = "18100822165@163.com"; // 发件人地址
	    static String TO = "1377631679@qq.com"; // 收件人地址
	    static String USER = "18100822165"; // 用户名
	    static String PWD = "mw090512015"; // 163的授权码
	    static String SUBJECT = "debug"; // 邮件标题
	    static String[] TOS = {"1377631679@qq.com"};
